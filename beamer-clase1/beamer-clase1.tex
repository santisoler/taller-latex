...
Muchas veces nos encontraremos que \LaTeX{} no puede resolver nuestro problemas por sí solo. En esos casos es necesario incluir ``mejoras'' a nuestro documento, y eso lo hacemos a través del uso de \textbf{paquetes}.
