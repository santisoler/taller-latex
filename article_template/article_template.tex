...
\usepackage{amsmath}  % paquetes AMS para expandir las capacidades matematicas
\usepackage{amsfonts} % paquetes AMS para expandir las capacidades matematicas
\usepackage{amssymb}  % paquetes AMS para expandir las capacidades matematicas
\usepackage[hmargin=3cm, vmargin=3cm]{geometry} % geometría de la hoja del pdf
...
\usepackage{hyperref} % paquete para generar hipervinculos
\hypersetup{
...
\urlstyle{same}             % url will have the same font as the text


\title{\textbf{Template de un Artículo Científico}} % el \textbf permite poner el texto en negrita
\author{Isaac Newton}
\date{\today} % si no deseamos que aparezca la fecha dejamos en blanco el campo date
...
\begin{table}[h] % Entre corchetes defino la posicion de la tabla en la pagina.
 \centering
 {\small % Cambie el tamano de letra
...
\newpage % crea un salto de página
