...
\hypersetup{         % Configura el comportamiento de los enlaces
  ...
  linkcolor=blue,    % Color de las referencias cruzadas
  filecolor=magenta, % Color de los enlaces de archivos locales
  urlcolor=cyan,     % Color de los enlaces de web sites
  }
\urlstyle{same}      % Los enlaces tendrán el estilo del documento
\end{verbatim}
}
\end{frame}
...
Visiten la pagina wikibooks (\url{https://en.wikibooks.org/wiki/LaTeX})
para más información o abran el archivo
...
Visiten la pagina wikibooks (\url{https://en.wikibooks.org/wiki/LaTeX}) para más información o abran el archivo \href{../article_template/article_template.pdf}{article\_template.pdf}.
}
